...
class radius_mono {
	protected:
		...
		inline void r_init([[maybe_unused]]int ijk,[[maybe_unused]]int s) {}
		/** Sets a required constant to be used when carrying out a
		 * plane bounds check. */
		inline void r_prime([[maybe_unused]]double rv) {}
		...
		inline double r_current_sub(double rs,[[maybe_unused]]int ijk,[[maybe_unused]]int q) {return rs;}
		...
		inline double r_scale(double rs,[[maybe_unused]]int ijk,[[maybe_unused]]int q) {return rs;}
		 ...
		 * otherwise. */
		inline bool r_scale_check(double &rs,double mrs,[[maybe_unused]]int ijk,[[maybe_unused]]int q) {return rs<mrs;}
};
